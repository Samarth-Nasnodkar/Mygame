	...
	public:
		...
		bool shootable(int currentx , int currenty , int userx , int usery , int enemyx , int enemyy, string direction){
			...
			if(direction == "f"){
				...
				if(enemyy > usery){
					if(currenty < usery && currentx == userx){
						return true;
					}
					...
					if(currenty < usery && currenty > enemyy && currentx == userx){
						return true;
					}
					return false;
				}
				...
				if(enemyx > userx){
					if(currentx < userx && currenty == usery){
						return true;
					}
					...
					if(currentx < userx && currentx > enemyx && currenty == usery){
						return true;
					}
					return false;
				}
